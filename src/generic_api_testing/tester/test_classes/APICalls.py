...
class APICalls():
    ...
    def check_api_response_values(campos_retorno_api, origem_retorno_api, tipo_comparacao, valores_esperados_retorno_api):
    ...
    def check_api_response_values_in_unordered_fields(campo_retorno_api, campos_relacionados_api, valores_relacionados_api, valor_esperado_retorno_api):
    ...
    def check_api_response_fields(campos_retorno_api, situacao_campos, origem_retorno_api):
